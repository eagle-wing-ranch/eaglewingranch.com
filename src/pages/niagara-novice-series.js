  ...
  return (
    <>
      <Heading
        ...
        subtitle={
          <>
            Professional, fun and safe show atmosphere for riders of all ages.
          </>
        }
      ...
      <Container>
        ...
        <p>
          Eagle Wing Ranch is dedicated to bring you a professional, fun and
          safe show atmosphere for riders of all ages.
        </p>

        <Button target="_blank" href="https://www.facebook.com/NiagaraNS">
        ...
        <Grid lg={3} xl={3} gap={false}>
          {data.allFile.edges.map(({ node }, i) => {
            ...
            return (
              <Sponsor key={i} url={URLS[node.name]} title={node.name}>
                <a
                  target="_blank"
      ...
      <InstagramFeed instagramId="7663664610">
        <div style={{ textAlign: "center", paddingTop: "2rem" }}>
          <Button
            target="_blank"
            href="https://instagram.com/NiagaraNovice.Series/"
          >
            Follow Niagara Novice Series on Instagram
          </Button>
        </div>
      </InstagramFeed>
